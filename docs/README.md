...
> Inventário do estado atual, gerado em 2026-09-23. Serve como mapa de migração para a reconstrução da wiki.
...
- Imagens catalogadas: **633** (496 GIF, 135 PNG e 2 JPG).
- Assets referenciados no código: **433**.
